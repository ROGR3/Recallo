...
pub static UNITS: &[UnitInfo] = &[
    ...
    UnitInfo {
        ...
        unit: 3,
        name: "Belongings",
        description: "Use possessive pronouns",
        emoji: "🎒",
    },
    UnitInfo {
        section: 1,
    ...
    UnitInfo {
        ...
        unit: 6,
        name: "Matjib",
        description: "Ask questions about food",
        emoji: "🍲",
    },
    UnitInfo {
        section: 1,
    ...
    UnitInfo {
        ...
        unit: 8,
        name: "Airport",
        description: "Find your way at the airport",
        emoji: "✈️",
    },
    UnitInfo {
        section: 1,
    ...
    UnitInfo {
        ...
        unit: 10,
        name: "Game Day",
        description: "Enjoy a sports event",
        emoji: "⚽",
    },
    // ── Section 2 · CEFR A1 ─────────────────────────────────────────────────
    UnitInfo {
    ...
    UnitInfo {
        ...
        unit: 3,
        name: "Camping",
        description: "Discuss the weather",
        emoji: "⛺",
    },
    UnitInfo {
        section: 2,
        unit: 4,
        name: "New House",
        description: "Look for a new home",
        emoji: "🏢",
    },
    UnitInfo {
        section: 2,
        unit: 5,
        name: "Blind Date",
        description: "Introduce new friends",
        emoji: "💑",
    },
    UnitInfo {
        section: 2,
        unit: 6,
        name: "Incheon",
        description: "Use location and destination markers",
        emoji: "📍",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 12,
        name: "Transport",
        description: "Navigate local transport",
        emoji: "🚌",
    },
    UnitInfo {
        section: 2,
        unit: 13,
        name: "Market",
        description: "Use adjectives to describe nouns",
        emoji: "🛒",
    },
    UnitInfo {
        section: 2,
        unit: 14,
        name: "Doctor",
        description: "Discuss health concerns",
        emoji: "🏥",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 16,
        name: "Shopping",
        description: "Shop for clothes and items",
        emoji: "👗",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 18,
        name: "New Job",
        description: "Use formal commands",
        emoji: "💼",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 20,
        name: "Volunteer",
        description: "Use the future tense",
        emoji: "🤝",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 22,
        name: "Excuses",
        description: "Explain why you can't do something",
        emoji: "🙅",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 24,
        name: "Help",
        description: "Check on someone's well-being",
        emoji: "🆘",
    },
    UnitInfo {
        section: 2,
    ...
    UnitInfo {
        ...
        unit: 26,
        name: "Olympics",
        description: "Use time expressions",
        emoji: "🏅",
    },
    UnitInfo {
        section: 2,
        unit: 27,
        name: "Exams",
        description: "Discuss exams and study habits",
        emoji: "📝",
    },
    UnitInfo {
        section: 2,
...
const S2U23: &[&str] = &["김밥", "라면", "만두", "치킨", "포장하다"];
const S2U24: &[&str] = &[
    "메시지",
    "문자",
    "전화하다",
...
const S2U25: &[&str] = &["캐릭터", "레벨", "피씨방", "컴퓨터", "인터넷", "게임"];
const S2U26: &[&str] = &[
    "올림픽",
    "선수",
    "태권도",
...
pub fn get_unit(section: u8, unit: u8) -> Option<&'static UnitInfo> {
    UNITS
        .iter()
        .find(|u| u.section == section && u.unit == unit)
}
